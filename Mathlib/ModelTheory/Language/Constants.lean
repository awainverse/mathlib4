...
public import Mathlib.ModelTheory.Language.Sum

/-!
# Languages With Additional Constants

Defines first-order languages in the style of the [Flypitch project](https://flypitch.github.io/)
which consist entirely of constants, or which add constants to an existing language.

## Main Definitions

- Given a type `α`, the language `FirstOrder.Language.constantsOn` consists only of constants
